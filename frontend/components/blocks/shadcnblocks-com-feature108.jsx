    ...
    <section className="py-32 bg-neutral-950 text-white">
      <div className="container mx-auto">
        <div className="flex flex-col items-center gap-4 text-center">
          <Badge variant="outline" className="bg-neutral-950 text-white border-neutral-800">{badge}</Badge>
        ...
        <Tabs defaultValue={tabs[0].value} className="mt-8">
          <TabsList
            ...
            {tabs.map((tab) => (
              <TabsTrigger
                key={tab.value}
                value={tab.value}
                className="flex items-center gap-2 rounded-xl px-4 py-3 text-sm font-semibold text-neutral-400 
          ...
          <div
            className="mx-auto mt-8 max-w-screen-xl rounded-2xl p-6 lg:p-16 bg-neutral-900">
            {tabs.map((tab) => (
              <TabsContent
                key={tab.value}
                value={tab.value}
                ...
                <div className="flex flex-col gap-5">
                  <Badge variant="outline" className="w-fit bg-neutral-950 text-white border-neutral-800">
                    {tab.content.badge}
                  </Badge>
